...
int main(int argc, char **argv) {
    ...
    final(x, y, c) = normalize(x, y, c);
    {
        ...
        Halide::Var _x0, _y1, _c2, _y4, _c5, _x6, _y7, _c8, _x9, _y10, _c11, _y13, _x15, _y16, _c17, _x18, _y19, _c20, _x21, _x24, _y25, _c26, _x27, _y28, _c29;
        Halide::Func(funcs["clamped"])
        .split(x, x, _x0, 2)
        .split(y, y, _y1, 2)
        .split(c, c, _c2, 8)
        .reorder(_c2, _x0, _y1, x, c, y)
        .reorder_storage(c, x, y)
        .compute_at(Halide::Func(funcs["downsampled"]), c)
        ;
        Halide::Func(funcs["downsampled"])
        .split(y, y, _y4, 2)
        .split(c, c, _c5, 4)
        .reorder(_c5, c, _y4, y, x)
