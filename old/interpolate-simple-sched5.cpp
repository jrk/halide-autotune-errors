...
int main(int argc, char **argv) {
    ...
    final(x, y, c) = normalize(x, y, c);
    {
        ...
        Halide::Var _x0, _y1, _c2, _y4, _x6, _y7, _c8, _x9, _c11, _x12, _y13, _x15, _y16, _x18, _y19, _c20, _x21, _y22, _x24, _y25, _c26, _y28, _c29, _x30, _y31, _c32, _x33, _y34, _c35, _x36, _y37, _c38, _y40, _c41, _x42, _y43, _c44;
        Halide::Func(funcs["clamped"])
        .split(x, x, _x0, 64)
        .split(y, y, _y1, 8)
        .split(c, c, _c2, 2)
        .reorder(_x0, _c2, _y1, x, y, c)
        ...
        .split(x, x, _x12, 4)
        .split(y, y, _y13, 16)
        .reorder(_y13, _x12, y, x, c)
        .reorder_storage(x, y, c)
        .vectorize(_y13, 2)
        .compute_at(Halide::Func(funcs["downsampled$2"]), _c8)
        ;
        Halide::Func(funcs["downx$3"])
        .split(x, x, _x15, 2)
        .split(y, y, _y16, 16)
        .reorder(_y16, c, _x15, y, x)
        .reorder_storage(c, x, y)
        .vectorize(_y16, 8)
        .compute_at(Halide::Func(funcs["downsampled$3"]), _x9)
        ;
        Halide::Func(funcs["interpolated$2"])
        .split(x, x, _x18, 16)
        .split(y, y, _y19, 8)
        .split(c, c, _c20, 4)
        .reorder(_x18, _y19, y, x, _c20, c)
        .reorder_storage(x, c, y)
        .vectorize(_x18, 2)
        .compute_at(Halide::Func(funcs["upsampledx$3"]), c)
        ;
        Halide::Func(funcs["interpolated$3"])
        .split(x, x, _x21, 4)
        .split(y, y, _y22, 8)
        .reorder(_y22, y, _x21, c, x)
        .reorder_storage(c, x, y)
        .compute_at(Halide::Func(funcs["upsampledx$3"]), _y40)
        ;
        Halide::Func(funcs["interpolated$4"])
        .split(x, x, _x24, 16)
        .split(y, y, _y25, 2)
        .split(c, c, _c26, 2)
        .reorder(_x24, _c26, c, _y25, x, y)
        .reorder_storage(y, c, x)
        .vectorize(_x24, 8)
        ...
        .split(y, y, _y37, 2)
        .split(c, c, _c38, 2)
        .reorder(_x36, x, _c38, c, _y37, y)
        .reorder_storage(c, x, y)
        .vectorize(_x36, 8)
        .compute_at(Halide::Func(funcs["upsampledx$3"]), _c41)
        ;
        Halide::Func(funcs["upsampledx$3"])
        .split(y, y, _y40, 8)
        .split(c, c, _c41, 2)
        .reorder(_y40, y, _c41, c, x)
        .reorder_storage(y, c, x)
        .vectorize(_y40, 4)
        .parallel(x)
        .compute_root()
