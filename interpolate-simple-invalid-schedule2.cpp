...
int main(int argc, char **argv) {
    ...
    final(x, y, c) = normalize(x, y, c);
    {
        ...
        Halide::Var _x0, _y1, _x3, _y4, _c5, _y7, _c8, _x9, _y10, _y13, _x15, _y16, _c17, _c20, _y22, _c23, _x24, _c29, _x30, _y31, _c32, _c35, _x36, _c38, _x39, _y40, _c41, _x42, _y43, _c44;
        Halide::Func(funcs["clamped"])
        .split(x, x, _x0, 4)
        .split(y, y, _y1, 32)
        .reorder(_y1, c, _x0, y, x)
        .reorder_storage(c, x, y)
        .vectorize(_y1, 8)
        .compute_at(Halide::Func(funcs["downsampled"]), _y4)
        ;
        Halide::Func(funcs["downsampled"])
        .split(x, x, _x3, 8)
        .split(y, y, _y4, 32)
        .split(c, c, _c5, 2)
        .reorder(_y4, _c5, _x3, y, c, x)
