...
int main(int argc, char **argv) {
    ...
    final(x, y, c) = normalize(x, y, c);
    {
        ...
        Halide::Var _x0, _y1, _c2, _x3, _y4, _y7, _c8, _y13, _c14, _x15, _y16, _c17, _x18, _y19, _c20, _x21, _y22, _c23, _x24, _y25, _c26, _x27, _y28;
        Halide::Func(funcs["clamped"])
        .split(x, x, _x0, 2)
        .split(y, y, _y1, 16)
        .split(c, c, _c2, 4)
        .reorder(_y1, _x0, _c2, y, x, c)
        .reorder_storage(y, c, x)
        .vectorize(_y1, 2)
        .compute_at(Halide::Func(funcs["downsampled"]), _x3)
        ;
        Halide::Func(funcs["downsampled"])
        .split(x, x, _x3, 16)
        .split(y, y, _y4, 4)
        .reorder(_x3, x, _y4, c, y)
        ...
        .split(y, y, _y19, 2)
        .split(c, c, _c20, 16)
        .reorder(_c20, c, _x18, _y19, x, y)
        .reorder_storage(c, x, y)
        .vectorize(_c20, 2)
        .compute_at(Halide::Func(funcs["final"]), _x27)
        ;
        Halide::Func(funcs["upsampled$2"])
        .split(x, x, _x21, 4)
        .split(y, y, _y22, 8)
        .split(c, c, _c23, 32)
        .reorder(_c23, _x21, _y22, c, y, x)
