...
int main(int argc, char **argv) {
    ...
    final(x, y, c) = normalize(x, y, c);
    {
        ...
        Halide::Var _x0, _y1, _c2, _y4, _c5, _x6, _c8, _x9, _y10, _c11, _x12, _y13, _c14, _x15, _y16, _c17, _y22, _c23, _y25, _c26, _y28, _c29;
        Halide::Func(funcs["clamped"])
        .split(x, x, _x0, 2)
        .split(y, y, _y1, 4)
        .split(c, c, _c2, 8)
        .reorder(_y1, _x0, y, _c2, x, c)
        ...
        .split(y, y, _y25, 8)
        .split(c, c, _c26, 8)
        .reorder(_c26, _y25, c, y, x)
        .reorder_storage(c, y, x)
        .vectorize(_c26, 2)
        .compute_at(Halide::Func(funcs["upsampled$2"]), x)
        ;
        Halide::Func(funcs["final"])
        .split(y, y, _y28, 2)
        .split(c, c, _c29, 8)
        .reorder(_c29, c, _y28, y, x)
        .reorder_storage(x, y, c)
        .vectorize(_c29, 4)
        .parallel(x)
        .compute_root()
